...
fun Page_Settings( changePageTo: (Int) -> Unit, productListState: ProductListState ){
    Content_Group_withTitle({
        ...
        Content_Group_withH2({
            ...
            Content_Surface(
                modifier = Modifier.fillMaxWidth().clickable(onClick = { productListState.loadSample() }),
                left = {
            ...
            Content_Surface(
                modifier = Modifier.fillMaxWidth().clickable(onClick = { productListState.clear() }),
                left = {
        ...
        Content_Group_withH2({
            ...
            Content_Surface(
                modifier = Modifier.fillMaxWidth().clickable(onClick =  { changePageTo(-2) }),
                left = {
